...
export function SiteFooter() {
  return (
    <footer className="bg-gray-900 py-16 border-t border-purple-500/30 relative overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12">
            <div className="mb-8 md:mb-0">
              <h2 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-500 to-cyan-400 mb-2">
                FaceMojo
              </h2>
              <p className="text-gray-300">Bring your photos to life with AI</p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              ...
              <div className="col-span-2 md:col-span-1">
                ...
                <div className="flex items-center mb-2">
                  ...
                  <a href="mailto:hello@facemojo.ai" className="text-gray-400 hover:text-white transition-colors">
                    hello@facemojo.ai
                  </a>
                </div>
                <div className="flex space-x-4 mt-4">
                  <a
                    href="#"
                    className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-purple-900 transition-colors"
                  >
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <p className="text-sm text-gray-500">&copy; {new Date().getFullYear()} FaceMojo. All rights reserved.</p>
            </div>
